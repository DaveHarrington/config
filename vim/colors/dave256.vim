...
hi Folded		ctermfg=103		ctermbg=234		cterm=none		guifg=#a0a8b0	guibg=#3a4046	gui=none
...
hi SpecialKey	ctermfg=241		ctermbg=232		cterm=none		guifg=#626262	guibg=#2b2b2b	gui=none
...
hi ColorColumn					ctermbg=233										guibg=#2d2d2d
endif
